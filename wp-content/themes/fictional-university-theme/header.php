            ...
            <div class="site-header__menu group">
                <nav class="main-navigation">
                    <ul>
                        ...
                        <li <?php if (is_page('past-events') or get_post_type() == 'event') echo 'class="current-menu-item"' ?>>
                ...
                <div class="site-header__util">
                    <a href="<?php echo site_url('/about-us') ?>" class="btn btn--small btn--orange float-left push-right">Login</a>
                    <a href="<?php echo site_url('/about-us') ?>" class="btn btn--small btn--dark-orange float-left">Sign Up</a>
